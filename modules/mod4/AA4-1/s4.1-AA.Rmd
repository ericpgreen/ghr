...
This R notebook accompanies the [Session 4.1 application activity](http://www.globalhealthresearch.co/modules/mod4/s4-1/) for [Global Health Research: Designs and Methods](http://www.globalhealthresearch.co/). To get started:
...
2. Click the "Code" button in the top right corner of this page and download the `Rmd` file.
3. Back in RStudio, go to the `Files` tab, and `Upload` the `Rmd` file you just downloaded. Then open it in RStudio.
