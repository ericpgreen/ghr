...
# packages
  ...
  library(httr)
# document setttings
  knitr::opts_chunk$set(result='hide')  # put a pound sign before this line
# rounding functions
...
For the purpose of this activity, let's take this value, `r singleP`, as the "truth". This is the true proportion of adults (≧15 years) that was reported to be single, never married when the census was conducted. 
...
Do the same sequence of draws for age.
