...
This course will incorporate pedagogical concepts and strategies from "flipped" classrooms. Students must prepare for class sessions by reading, watching videos, and completing readiness assessments. **Click on the session links on the schedule to understand the expectations for each session.** 
